...
def main():
    print("="*80)
    print(f"Starting experiment: alpha=0.001, VP2_bins=30")
    print("="*80)
    
    # Load and prepare data
    data = prepare_data('sample_data_oviss.csv', 30)
    
    # Create experiment directory
    exp_dir = os.path.join('experiment/discrete_cql_20250827_072052', 'alpha0.001_bins30')
    ...
    print(f"\n✅ Experiment completed: alpha=0.001, bins=30")
...
if __name__ == "__main__":
    try:
        ...
        print(f"ERROR in experiment alpha=0.001, bins=30: {e}", file=sys.stderr)
        import traceback
        traceback.print_exc()
        sys.exit(1)
