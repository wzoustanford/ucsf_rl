...
def main():
    print("="*80)
    print(f"Starting experiment: alpha=0.01, VP2_bins=50")
    print("="*80)
    ...
    exp_dir = os.path.join('experiment/discrete_cql_20250827_072052', 'alpha0.01_bins50')
    ...
    print(f"\n✅ Experiment completed: alpha=0.01, bins=50")
...
if __name__ == "__main__":
    try:
        ...
        print(f"ERROR in experiment alpha=0.01, bins=50: {e}", file=sys.stderr)
        import traceback
        traceback.print_exc()
        sys.exit(1)
